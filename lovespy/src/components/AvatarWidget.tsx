...
export default function AvatarWidget() {
  ...
  useEffect(() => {
    ...
    // Auto-pop the bubble when cart value updates
    setBubbleOpen(true);
  ...
  const renderMascot = () => {
    return (
      <svg viewBox="0 0 120 120" className="w-full h-full select-none drop-shadow-lg" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="35" cy="35" r="12" fill="#D946EF" opacity="0.3" /> {/* Highlight */}
        <circle cx="85" cy="35" r="12" fill="#D946EF" opacity="0.3" /> {/* Highlight */}
        ...
        {emotion === "inlove" && (
          <>
            ...
            {/* Big red heart eyes */}
            <path
              d="M44 57C41.5 54.5 37.5 55.5 37.5 59.5C37.5 63.5 44 68 44 68C44 68 50.5 63.5 50.5 59.5C50.5 55.5 46.5 54.5 44 57Z"
              fill="#FF3366"
            />
            <path
              d="M76 57C73.5 54.5 69.5 55.5 69.5 59.5C69.5 63.5 76 68 76 68C76 68 82.5 63.5 82.5 59.5C82.5 55.5 78.5 54.5 76 57Z"
              fill="#FF3366"
            />
          </>
        )}
        ...
        {emotion === "inlove" && (
          <>
            {/* Hands forming a heart in front of chest */}
            ...
            {/* Heart floating near face */}
            <path
              d="M102 85C100.5 83.5 98 84.5 98 87C98 89.5 102 92 102 92C102 92 106 89.5 106 87C106 84.5 103.5 83.5 102 85Z"
              fill="#FF3366"
  ...
  // Border/bg wrapper colors based on state
  const colors = {
